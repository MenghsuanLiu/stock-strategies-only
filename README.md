...
> 🏗️ **進行中的大改版（V3.4）**：正在把策略系統重構成「**多流派因子 × 持有週期 × 大盤 regime 自適應**」，用**多角色 AI 專家協作**設計、**確定性回測引擎**驗證。**P1 資料層 + P2 因子層（29 因子）已完成、105 測試全綠**。完整說明見下方 → [🏗️ V3.4 章節](#️-v34進行中--多角色股市策略系統重構)
